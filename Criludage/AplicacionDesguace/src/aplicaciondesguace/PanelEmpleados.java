...
public class PanelEmpleados extends javax.swing.JPanel {
    ...
    public PanelEmpleados(FormBase b,Empleado e) {
        ...
        public void mouseReleased(MouseEvent e){
            if(e.getClickCount()>=2){
                ...
                String usuario = tablaEmpleados.getValueAt(tablaEmpleados.getSelectedRow(), 1).toString();
                base.addPanel(new PanelEditarEmpleado(base, emp.getEmpleadoPorUsuario(base.getConfiguracion().getBdHost(), usuario)));
            }
        }
        });
    ...
    public void Refrescar(){
        ...
        empleados = empleado.obtenerTodos(base.getConfiguracion().getBdHost());
        ...
        if(fila != -1){
            if(tablaEmpleados.getRowCount() > fila){
