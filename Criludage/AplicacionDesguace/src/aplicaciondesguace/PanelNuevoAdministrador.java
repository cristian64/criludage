 ...
 */
public class PanelNuevoAdministrador extends javax.swing.JPanel {

    /** Creates new form PanelPropuesta */
    public PanelNuevoAdministrador(FormBase b,Empleado e) {
        initComponents();
    ...
    private void initComponents() {
        ...
        etiqTitulo.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        etiqTitulo.setText("Nuevo Administrador");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(3, 3, 3)))
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(campoNombre, javax.swing.GroupLayout.DEFAULT_SIZE, 658, Short.MAX_VALUE)
                            .addComponent(campoNIF, javax.swing.GroupLayout.DEFAULT_SIZE, 658, Short.MAX_VALUE)
                            .addComponent(campoCorreo, javax.swing.GroupLayout.DEFAULT_SIZE, 658, Short.MAX_VALUE)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(campoUsuario, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 658, Short.MAX_VALUE)
                                    .addComponent(campoPassword1, javax.swing.GroupLayout.DEFAULT_SIZE, 658, Short.MAX_VALUE)
                                    .addComponent(campoPassword2, javax.swing.GroupLayout.DEFAULT_SIZE, 658, Short.MAX_VALUE))))))
                .addContainerGap())
        );
    ...
    private void botonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonGuardarActionPerformed
        ...
        // compruebo si ya existe el usuario introducido
        nuevo = nuevo.getEmpleadoPorUsuario(base.getConfiguracion().getBdHost(), campoUsuario.getText());
        // si el nombre de usuario tiene mas de 3 letras
        if (campoUsuario.getText().length() >= 3) {
                ...
                if(nuevo == null){
                    ...
                    if (campoPassword1.getPassword().length > 0) {
                        ...
                        if (new String(campoPassword1.getPassword()).equals(new String(campoPassword2.getPassword()))) {
                            ...
                            if (m.find()) {
                                // creo un nuevo empleado
                                nuevo = new Empleado();
                                // le asigno los valores introducidos
                                nuevo.setUsuario(campoUsuario.getText());
                                try{
                                    SHA1 sha = new SHA1();
                                    nuevo.setContrasena(sha.getHash(campoPassword1.getPassword().toString()));
                                }
                                catch(NoSuchAlgorithmException ex){

                                }
                                nuevo.setCorreoElectronico(campoCorreo.getText());
                                nuevo.setNif(campoNIF.getText());
                                nuevo.setNombre(campoNombre.getText());
                                nuevo.setAdministrador(opcionSi.isSelected());

                                // lo guardo
                                nuevo.guardar(base.getConfiguracion().getBdHost());
                                // borro el panel
                                base.deletePanel();
                                // dejo constancia en el log
                                addLog("Añadido administrador: " + nuevo.getUsuario());
                        ...
                        // emito error
                        JOptionPane.showMessageDialog(this, "Debes introducir una contraseña", "Contraseña invalida", JOptionPane.ERROR_MESSAGE);
                    }
                }
                else{
                    // emito error
                    JOptionPane.showMessageDialog(this, "El nombre de usuario ya existe", "Nombre invalido", JOptionPane.ERROR_MESSAGE);
                }
            }
            else {
                // emito error
                JOptionPane.showMessageDialog(this, "El nombre debe contener al menos 3 caracteres", "Nombre invalido", JOptionPane.ERROR_MESSAGE);
            }
