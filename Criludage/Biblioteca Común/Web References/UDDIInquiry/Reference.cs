...
namespace Biblioteca_Común.UDDIInquiry {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="UDDI_Inquiry_PortSoapBinding", Namespace="urn:uddi-org:v3_service")]
    public partial class UDDI_Inquiry_Port : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public UDDI_Inquiry_Port() {
            this.Url = global::Biblioteca_Común.Properties.Settings.Default.Biblioteca_Común_UDDIInquiry_UDDI_Inquiry_Port;
        ...
        public bindingDetail get_bindingDetail([System.Xml.Serialization.XmlElementAttribute("get_bindingDetail", Namespace="urn:uddi-org:api_v3", IsNullable=true)] get_bindingDetail get_bindingDetail1) {
        ...
        [return: System.Xml.Serialization.XmlElementAttribute("serviceList", Namespace="urn:uddi-org:api_v3", IsNullable=true)]
        public serviceList find_service([System.Xml.Serialization.XmlElementAttribute("find_service", Namespace="urn:uddi-org:api_v3", IsNullable=true)] find_service find_service1) {
        ...
        public serviceDetail get_serviceDetail([System.Xml.Serialization.XmlElementAttribute("get_serviceDetail", Namespace="urn:uddi-org:api_v3", IsNullable=true)] get_serviceDetail get_serviceDetail1) {
        ...
        public tModelDetail get_tModelDetail([System.Xml.Serialization.XmlElementAttribute("get_tModelDetail", Namespace="urn:uddi-org:api_v3", IsNullable=true)] get_tModelDetail get_tModelDetail1) {
        ...
        [return: System.Xml.Serialization.XmlElementAttribute("bindingDetail", Namespace="urn:uddi-org:api_v3", IsNullable=true)]
        public bindingDetail find_binding([System.Xml.Serialization.XmlElementAttribute("find_binding", Namespace="urn:uddi-org:api_v3", IsNullable=true)] find_binding find_binding1) {
        ...
        [return: System.Xml.Serialization.XmlElementAttribute("businessList", Namespace="urn:uddi-org:api_v3", IsNullable=true)]
        public businessList find_business([System.Xml.Serialization.XmlElementAttribute("find_business", Namespace="urn:uddi-org:api_v3", IsNullable=true)] find_business find_business1) {
        ...
        public businessDetail get_businessDetail([System.Xml.Serialization.XmlElementAttribute("get_businessDetail", Namespace="urn:uddi-org:api_v3", IsNullable=true)] get_businessDetail get_businessDetail1) {
        ...
        [return: System.Xml.Serialization.XmlElementAttribute("relatedBusinessesList", Namespace="urn:uddi-org:api_v3", IsNullable=true)]
        public relatedBusinessesList find_relatedBusinesses([System.Xml.Serialization.XmlElementAttribute("find_relatedBusinesses", Namespace="urn:uddi-org:api_v3", IsNullable=true)] find_relatedBusinesses find_relatedBusinesses1) {
        ...
        [return: System.Xml.Serialization.XmlElementAttribute("tModelList", Namespace="urn:uddi-org:api_v3", IsNullable=true)]
        public tModelList find_tModel([System.Xml.Serialization.XmlElementAttribute("find_tModel", Namespace="urn:uddi-org:api_v3", IsNullable=true)] find_tModel find_tModel1) {
        ...
        [return: System.Xml.Serialization.XmlElementAttribute("operationalInfos", Namespace="urn:uddi-org:api_v3", IsNullable=true)]
        public operationalInfos get_operationalInfo([System.Xml.Serialization.XmlElementAttribute("get_operationalInfo", Namespace="urn:uddi-org:api_v3", IsNullable=true)] get_operationalInfo get_operationalInfo1) {
