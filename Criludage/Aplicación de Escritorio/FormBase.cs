        ...
        private void timerConsumirSolicitudes_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (consumidorSolicitudes.ConexionActiva())
                {
                    ...
                    {
                        RSA enc = new RSA(
                            "113300758404461202332310129764569035125485318029044758737411860949339912355523",
                            "",
                        ...
                        SGC.ENSolicitud solicitud = CreateENSolicitudFromXML(enc.Desencriptar(xml));
                        if (solicitud != null)
                        {
