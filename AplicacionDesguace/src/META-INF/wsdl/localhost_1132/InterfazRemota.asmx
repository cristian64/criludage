...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/InterfazRemota.asmx?disco" />
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">InterfazRemota</p><br>

      

      <span>

          <p class="intro">Las operaciones siguientes son compatibles. Para una definición formal, revise la <a href="InterfazRemota.asmx?WSDL">descripción de servicios</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="InterfazRemota.asmx?op=ActualizarCliente">ActualizarCliente</a>
              ...
              <li>
                <a href="InterfazRemota.asmx?op=ActualizarDesguace">ActualizarDesguace</a>
              ...
              <li>
                <a href="InterfazRemota.asmx?op=Inicializar">Inicializar</a>
              ...
              <li>
                <a href="InterfazRemota.asmx?op=ObtenerCliente">ObtenerCliente</a>
              ...
              <li>
                <a href="InterfazRemota.asmx?op=ObtenerClientePorUsuario">ObtenerClientePorUsuario</a>
              ...
              <li>
                <a href="InterfazRemota.asmx?op=ObtenerDesguace">ObtenerDesguace</a>
              ...
              <li>
                <a href="InterfazRemota.asmx?op=ObtenerDesguacePorUsuario">ObtenerDesguacePorUsuario</a>
              ...
              <li>
                <a href="InterfazRemota.asmx?op=ObtenerFinalizadasNoSincronizadas">ObtenerFinalizadasNoSincronizadas</a>
              ...
              <li>
                <a href="InterfazRemota.asmx?op=ObtenerPropuestas">ObtenerPropuestas</a>
              ...
              <li>
                <a href="InterfazRemota.asmx?op=ProponerPieza">ProponerPieza</a>
              ...
              <li>
                <a href="InterfazRemota.asmx?op=RegistroCliente">RegistroCliente</a>
              ...
              <li>
                <a href="InterfazRemota.asmx?op=RegistroDesguace">RegistroDesguace</a>
              ...
              <li>
                <a href="InterfazRemota.asmx?op=SolicitarPieza">SolicitarPieza</a>
